...
from keyboards_food import (
    ...
    edit_category_menu, edit_quantity_menu, month_menu_teacher, month_menu_admin, class_selection_menu, STAGE_NAMES
)
...
async def my_requests(event: MessageCallback):
    ...
    if not meals:
        ...
        for meal in meals:
            text += f"🏫 {meal.get('building')} | 📖 {meal.get('class_name')}\n"
